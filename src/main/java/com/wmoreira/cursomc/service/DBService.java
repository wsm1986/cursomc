...
import com.wmoreira.cursomc.domain.Estado;
...
import com.wmoreira.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "admin", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("admin"));
